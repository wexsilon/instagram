                ...
                <div class="row col-11 col-md-9 mt-5 pt-4">
                    <div class='card col-3 rounded-0 border-right-0 p-0 d-none d-md-inline'>
                        <ul type='none' class='p-0'>
                            <a href="edit.php"><li class='p-3 pl-4'>Edit Profile</li></a>
                            <a href="change_password.php"><li class='p-3 pl-4' style="border-left:2px solid black; font-weight:600;">Change Password</li></a>
                        </ul>
                    </div>
                        ...
                        <div class="card-content col-12 pl-lg-5 p-0">
                            <form method="POST" class="padding" enctype="multipart/form-data">
                                <div class='mb-4 text-start d-flex justify-content-end'>
                                    ...
                                    <input type="password" name="old_password" class="user-edit-form" placeholder="current passowrd">
                                </div>
                                <div class='mb-4 text-start d-flex justify-content-end'>
                                    <label><b>New password</b></label>
                                    <input type="password" name="new_password" class="user-edit-form" placeholder="new passowrd">
                                </div>
                                <div class='mb-4 text-start d-flex justify-content-end'>
                                    <label><b>Confirm password</b></label>
                                    <input type="password" name="confirm_new_password" class="user-edit-form" placeholder="confirm passowrd">
                                </div>
                                <button type="submit" class="btn" style="background-color: #0095f6;"><b style="color: #fff;">Change Password</b></button>               
                            </form>
                        </div>
                    </div>
                </div>
