        ...
        <main role="main" class="container-fluid">
            <div class='row justify-content-center'>         
                ...
                <div class='container col-12 col-lg-9 justify-content-start' style="padding: 0; margin-top: 5rem;">
                    ...
                    <?php
                    $sql = "SELECT id, photo ,comment_count, like_count FROM posts ORDER BY created_at DESC";
                    ...
                    ?>
                        <span class=' infinite-item post-overlay-container col-4 p-0 p-md-2'>
                            <img class="btn p-1" src="<?php echo $purl; ?>" style="width:100%; height: 100%;">
                ...
                <footer class='col-12 mb-1 mt-5 justify-content-center' style="font-size: 0.75rem; color:#8e8e8e;">
