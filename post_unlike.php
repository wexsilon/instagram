...
$deletetQueryLike = "DELETE FROM likes WHERE pid = ? AND username = ?";
$stmtQueryLike = $pdoObj->prepare($deletetQueryLike);
...
$tplc = $stmtQueryPost->fetch(PDO::FETCH_ASSOC);
$plc = intval($tplc['like_count']);
